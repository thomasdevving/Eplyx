...
const files = ['index.html','src/app.js','src/landing.js','src/session.js','src/projects.js','src/brand.js','src/intro.js','src/core-scene.js','src/sculpture.js','src/analyse.js','src/report.js','src/styles.css','public/logo.svg'];
