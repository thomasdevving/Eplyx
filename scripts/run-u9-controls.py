#!/usr/bin/env python3
"""Re-run frozen product controls for Phase U9 without touching U8 artifacts."""
...
OUT = REPO / "docs/examples/phase-u9-freeze"
EXPECTED = {
...
def main() -> int:
    ...
    kamino = [run("verify", verify, False), run("baseline", baseline, False), run("offline_verify", verify, True), run("offline_ci", baseline, True)]
    result = {
